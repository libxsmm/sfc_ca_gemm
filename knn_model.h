...
******************************************************************************/
/*
 * k-NN Model for GEMM Configuration Prediction
 ...
 *       int kbf, K_layers;
 *       predict_config_knn(M, N, K, &kbf, &K_layers);
...
int get_knn_k_value(void);           /* Returns k (number of neighbors) */
int get_knn_training_samples(void);  /* Returns number of training samples */
