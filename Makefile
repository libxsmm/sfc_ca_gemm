...
$(TARGET_ONEDNN): $(SOURCES_ONEDNN) $(HEADERS) $(KNN_MODEL_OBJ) $(ROOFLINE_PREDICTOR_OBJ)
	$(CXX) $(CXXFLAGS) $(IFLAGS) $(ONEDNN_IFLAGS) $(SOURCES_ONEDNN) $(KNN_MODEL_OBJ) $(ROOFLINE_PREDICTOR_OBJ) $(LFLAGS) $(ONEDNN_LFLAGS) $(LDFLAGS) $(ONEDNN_LDFLAGS) -lxsmm -ldnnl -o $@
